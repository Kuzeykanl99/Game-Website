			...
			<section>
				...
				<form action="index.php" method="post" class="login">
					...
					<table>
						...
						<tr><th><label for="user">User</label></th><td><input type="text" placeholder="Enter Username" name="user" value="<?php echo($_REQUEST['user']); ?>" /></td></tr>
						<tr><th><label for="password">Password</label></th><td> <input type="password" placeholder="Enter Password" name="password" /></td></tr>
						<tr><th>&nbsp;</th><td><input type="submit" name="submit" value="login" /></td></tr>
						<tr><th>&nbsp;</th><td><?php echo(view_errors($errors)); ?></td></tr>
					</table>
				</form>
				<a href="index.php?page=register" class="register_button">Register</a>
			</section>
			<section>
			</section>
		</main>
